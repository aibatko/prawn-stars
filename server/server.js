...
setInterval(()=>{
  game.update();
  const state=JSON.stringify({type:'state', players: game.players, bullets: game.bullets, cones: game.cones, flames: game.flames, aoes: game.aoes, warnings: game.warnings});
